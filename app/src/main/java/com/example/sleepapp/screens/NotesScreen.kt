...
fun NotesScreen() {
    ...
    val items = listOf<note>(
        ...
        note(dateFormat.parse("22.10.2022"), "Ночь", "«Эгоистичный ген» — классика научно-популярной литературы. С ней должен быть знаком каждый культурный человек. Как и «Войну и мир», вы должны хотя бы начать ее читать \uD83D\uDE09  Первоначально книга была задумана как оригинальный способ научно-популярного рассказа о биологической эволюции. Ричард Докинз заявил, что именно гены подвергаются естественному отбору, а не виды и не отдельные организмы. \n" +
                ...
                "\n" +
                "Кстати, на страницах этой книги впервые появился термин «мем». Ричард Докинз придумал это слово для обозначения единицы культурной информации, то есть информации, передающейся негенетическим путем. А теперь это едва ли не самое модное слово в сети.", arrayOf("#страшно", "#непонятно", "#плохо"),
            coffee = true,
            alcohol = false),
        note(dateFormat.parse("2.13.2020"), "Луга", "Это редкая книга. Ее автор — физик-теоретик, который одним из первых наблюдал удивительное явление — квантовую нелокальность. Он поставил эксперимент, основываясь на работах Бора и Гейзенберга, Эйнштейна и Белла. Жизан — один из тех, кто сегодня совершает «вторую квантовую революцию». Он отлично понимает, что вещи, о которых он говорит, трудно представить нормальному человеку. И Жизан тратит много сил, чтобы растолковать «квантовые чудеса», которые он сам совершал.\n" +
                "\n" +
                ...
                "\n" +
                "В книге нет формул. И это принципиальная позиция автора. Он говорит, что его цель — рассказать о физических идеях, а не забросать читателя математикой. Но в этой небольшой книге много метафор. Видимо, иначе и нельзя рассказать о «чудесном» квантовом мире. Это трудная книга, но разговор с современным «волшебником», безусловно, стоит потраченного времени.", arrayOf("#страшно", "#непонятно", "#плохо"),
            coffee = true,
            alcohol = true),
        note(dateFormat.parse("2.13.2020"), "Ненадо besi be fbw evfw ДЯДЯ", "Если вы решите подойти к серьезному ученому и попросите рассказать, как устроена Вселенная, «только покороче», то серьезный ученый проигнорирует вопрос — и будет прав. Но Стивен Хокинг —  звезда космологии, не нуждающаяся в представлениях — дерзнул придумать такой рассказ. И вышло действительно коротко: всего на 160 страницах у вас на глазах возникнет Вселенная, пространство, время и...  множество вопросов, которые растут, как головы Лернейской гидры. Ученые тратят столетия, отвечая на один, чтобы на его месте тут же появился еще десяток. \n" +
                "\n" +
